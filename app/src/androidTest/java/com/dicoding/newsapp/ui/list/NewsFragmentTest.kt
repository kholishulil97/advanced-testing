...
class NewsFragmentTest{
    ...
    fun getHeadlineNews_Success() {
        ...
        launchFragmentInContainer<NewsFragment>(bundle, com.dicoding.newsapp.R.style.Theme_News)
        ...
        onView(withId(com.dicoding.newsapp.R.id.rv_news))
    ...
    fun getHeadlineNews_Error() {
        ...
        onView(withId(com.dicoding.newsapp.R.id.tv_error))
            .check(matches(isDisplayed()))
